...
scaler_dir = folder + 'model/my_scaler.sav'
...
output_pred = 'output/kallpa_actualns.csv' # Nombre de archivo donde se publican los resultados.
...
rating_prediction(data, rf, rf_pure, feat_key, le, sov_lab_encoder, scaler, output_pred)
